...
(() => {
  ...
  function aboutToggle() {
    ...
    aboutEl.innerHTML = `<div class="st-about-box"><div class="st-about-h">HOW TO RECORD</div><ol>
      ...
      <div class="st-about-k">X AUTOPLAY (the computer fights for your side; the dial beside it is its skill; you can still drop units) · R record/stop · H UI in take · D hand in take · C cursor · M sound · T voice-over · A camera auto · arrows pan · F frame · Z zoom · V finder · P strip · HOME = this fight again</div>
